...
function [clist, centers2 particleMeans_org particleStd_org particlePatches_org] = DetectParticles(im, cnet, rbox_scale, sigma_gauss, f3, sigma, threshold, k_level)
