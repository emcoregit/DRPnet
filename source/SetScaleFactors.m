...
function [scale_factor, rbox_scale, sigma_gauss, f3] = SetScaleFactors(inpath, box_size)
...
numSlices=1;
debug=0;
[map0,s,hdr,extraHeader]=ReadMRC(fullfile(inpath,fname), startSlice, numSlices, debug);
dims = size(map0); 
